...
# Can I sell projects made with the Dash Packager?
...
The Dash Packager is provided under [a free and open source license](https://github.com/DashBlocks/packager/blob/master/LICENSE). You can use files generated by the packager in any way **with no license fee and no royalty**. In place of a license fee, we ask you to donate to and volunteer at charity organizations in your local community. They need your support far more than I do. Make your community a better place.

:::warning
[The Dash Packager offers no warranty. The authors can not be held liable for any damages.](https://github.com/DashBlocks/packager/blob/master/LICENSE#L261-L301)
:::
