...
Scratch will automatically show a checkbox to show a variable monitor by REPORTER blocks with no inputs. Note that in Dash, this applies to BOOLEAN, ARRAY, OBJECT blocks too. To disable this, set disableMonitor to true on the block.
